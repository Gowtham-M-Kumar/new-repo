...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='https://localhost,https://127.0.0.1,https://*.onrender.com,https://*.railway.app', cast=lambda v: [s.strip() for s in v.split(',')])
